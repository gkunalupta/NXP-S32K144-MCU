...
void GB_MA_SPI0_send_byte_conti(uint8_t val)
{
	...
	LPSPI_DRV_MasterTransferBlocking(INST_LPSPI_1,&val, &rx_value, 1, 100); //Transfer the data from MOSI to MISO
...
const lpspi_master_config_t lpspi_0_MasterConfig1 = {
  .bitsPerSec = 100000UL,
  .whichPcs = LPSPI_PCS0,
  .pcsPolarity = LPSPI_ACTIVE_HIGH,
  .isPcsContinuous = false,
